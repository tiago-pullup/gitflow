...
# http://github.com/tiago-pullup/gitflow/blob/master/Makefile

# Licensed under the same restrictions as git-flow:
# http://github.com/tiago-pullup/gitflow/blob/develop/LICENSE
...
if [ -z "$REPO_HOME" ] ; then
	REPO_HOME="http://github.com/tiago-pullup/gitflow.git"
fi
